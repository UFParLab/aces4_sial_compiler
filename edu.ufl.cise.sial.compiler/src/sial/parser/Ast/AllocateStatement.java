...
/**
 *<b>
 *<li>Rule 74:  Statement ::= allocate$ Ident AllocIndexListopt
 *</b>
 */
public class AllocateStatement extends ASTNode implements IStatement
{
    ...
    public AllocateStatement(IToken leftIToken, IToken rightIToken,
                             Ident _Ident,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof AllocateStatement)) return false;
        if (! super.equals(o)) return false;
        AllocateStatement other = (AllocateStatement) o;
