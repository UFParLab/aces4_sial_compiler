...
/**
 *<b>
 *<li>Rule 151:  Primary ::= StringLiteral
 *</b>
 */
public class StringLitExpr extends ASTNodeToken implements IPrimary
{
    ...
    public StringLitExpr(SialParser environment, IToken token)    {
        super(token);
