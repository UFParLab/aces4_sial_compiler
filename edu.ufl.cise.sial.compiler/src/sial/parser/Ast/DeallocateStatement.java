...
/**
 *<b>
 *<li>Rule 71:  Statement ::= deallocate$ Ident AllocIndexListopt
 *</b>
 */
public class DeallocateStatement extends ASTNode implements IStatement
{
    ...
    public DeallocateStatement(IToken leftIToken, IToken rightIToken,
                               Ident _Ident,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof DeallocateStatement)) return false;
        if (! super.equals(o)) return false;
        DeallocateStatement other = (DeallocateStatement) o;
