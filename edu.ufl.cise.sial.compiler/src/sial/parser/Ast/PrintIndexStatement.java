...
/**
 *<b>
 *<li>Rule 83:  Statement ::= print_index$ Ident
 *</b>
 */
public class PrintIndexStatement extends ASTNode implements IStatement
{
    ...
    public PrintIndexStatement(IToken leftIToken, IToken rightIToken,
                               Ident _Ident)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof PrintIndexStatement)) return false;
        if (! super.equals(o)) return false;
        PrintIndexStatement other = (PrintIndexStatement) o;
