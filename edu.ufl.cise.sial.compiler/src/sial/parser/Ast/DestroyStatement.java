...
/**
 *<b>
 *<li>Rule 98:  Statement ::= destroy$ Ident
 *</b>
 */
public class DestroyStatement extends ASTNode implements IStatement
{
    ...
    public DestroyStatement(IToken leftIToken, IToken rightIToken,
                            Ident _Ident)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof DestroyStatement)) return false;
        if (! super.equals(o)) return false;
        DestroyStatement other = (DestroyStatement) o;
