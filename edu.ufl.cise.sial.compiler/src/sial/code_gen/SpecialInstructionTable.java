...
public class SpecialInstructionTable {
	...
	public void write(SIADataOutput output) throws IOException {
		assert nSpecials == specialBiMap.size() : "mismatch between nSpecials="
				+ nSpecials + " and size=" + specialBiMap.size();
			...
			try {
				...
				System.err
						.println("EOF exception int SpecialInstructionTable read with i="
								+ i);
				System.err.print("nSpecials=");
				System.err.println(nSpecials);
				throw new RuntimeException(e);
			}
		}
	}

	public static SpecialInstructionTable readSpecialInstructionTable(
			SIADataInput input) throws IOException {
