...
\hline
121&allocate_contiguous_op&rank&arra_table_slot&&allocates memory for a region of a contiguous local array.  The boundaries are obtained from the control_stack where they have been pushed in the order rank-1_lower, rank-1_upper, 0_lower, 0_upper, etc.\\
\hline
122&deallocate_contiguous_op&rank&array_table_slot&&deallocates memory for a region of a contiguous local array.  The boundaries are obtained from the control_stack where they have been pushed in the order rank-1_lower, rank-1_upper, 0_lower, 0_upper, etc.\\
\hline
